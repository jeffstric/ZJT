"""create grid_image_tasks table

Revision ID: 20260325_094948
Revises: 20260323_001
Create Date: 2026-03-25 09:49:48
...
def downgrade():
    """删除 grid_image_tasks 表"""
    op.execute("DROP TABLE IF EXISTS `grid_image_tasks`")
