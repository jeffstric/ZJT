...
Multiple Angle Shots: Four different perspective photographs of the same location. Shot 1: [从正面角度拍摄的照片，展现主要入口和正面特征]. Shot 2: [从侧面角度拍摄的照片，展现侧面结构和深度]. Shot 3: [从另一个重要角度的照片描述，如鸟瞰或仰视]. Shot 4: [从背面或内部角度的照片描述]. All photographs maintain consistent architectural details, colors, and proportions. No characters, props, text, or written words appear in any shot. ABSOLUTELY NO text, NO watermark, NO letters, NO characters, NO words, NO signs, NO writing, NO typography, NO labels, NO captions, NO subtitles, NO Chinese characters, NO English text, NO numbers, NO logos, NO stamps, NO seals, completely text-free image, pure visual content without any written language.
```
...
Different Angles (Right): Four different perspective views of the same location arranged in a 2x2 grid. View 1 (Top Left): [从正面角度看到的场景，展现主要入口和正面特征]. View 2 (Top Right): [从侧面角度看到的场景，展现侧面结构和深度]. View 3 (Bottom Left): [从另一个重要角度的场景描述，如鸟瞰或仰视]. View 4 (Bottom Right): [从背面或内部角度的场景描述]. All views must maintain consistent architectural details, colors, and proportions. No characters, props, text, or written words should appear in any view. ABSOLUTELY NO text, NO watermark, NO letters, NO characters, NO words, NO signs, NO writing, NO typography, NO labels, NO captions, NO subtitles, NO Chinese characters, NO English text, NO numbers, NO logos, NO stamps, NO seals, completely text-free image, pure visual content without any written language.
```
