...
- 营销视频克隆当前支持 Seedance2.0、Seedance2.0 Fast、Seedance2.0 Mini（seedance2.0-mini）和 Seedance 2.5（seedance2.5）；白名单单一事实来源为 `config/unified_config.py::VIDEO_CLONE_DRIVER_KEYS`。专家提示词必须通过 `video_urls` 传入参考视频。人脸遮盖仅 Seedance 2.0 / Fast / Mini 显示「是否处理人脸」（`SEEDANCE_FACE_MASK_DRIVER_KEYS`，不含 2.5）；仅当偏好为「人脸处理: 已开启」时，才在克隆提示词末尾追加"将人脸位置的黑色方框修改为真人人脸。"
