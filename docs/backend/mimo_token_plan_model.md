...
| 工具调用 / 思考 / 视觉 | 1 / 1 / 1 | 1 / 1 / **0**（Pro 为纯文本模型，官方页标明输入/输出模态均为文本；no_127 误标视觉=1，no_131_20260909_fix_mimo_v25_pro_vl_flag 已修正并清理指向它的 VL 偏好） |
...
- `alembic/versions/no_131_20260909_fix_mimo_v25_pro_vl_flag.py`：修正 mimo-v2.5-pro
