...
class GptImage25CommonFlareV1Driver(GptImageCommonV1Driver):
    """GPT Image 2.5（flare）通用供应商驱动基类，复用 OpenAI 标准格式，仅替换上游模型名"""

    DEFAULT_MODEL = "gpt-image-2.5-flare"
    EDIT_MODEL = "gpt-image-2.5-flare"


class GptImage25CommonSunburstSite0V1Driver(GptImage25CommonSunburstV1Driver):
    """GPT Image 2.5 Sunburst Site 0 v1 版本驱动（固定YWAPI官方站点）"""
