...
from task.video_drivers.gemini_duomi_v1_driver import GeminiDuomiV1Driver


class TestGeminiDriverWithDB(BaseVideoDriverTest):
    """Gemini 驱动数据库集成测试"""
    ...
    def setUp(self):
        ...
        self.test_ai_tool_id = self.create_test_ai_tool(
            ai_tool_type=1,
            prompt='生成创意视频',
            image_path='https://example.com/gemini_image.jpg',
            duration=5
        )
    ...
    def test_update_gemini_task(self):
        """测试更新 Gemini 任务"""
        project_id = 'gemini_proj_test_123'
